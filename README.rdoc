...
* When a photo is discarded, leave the notification, but unlink in log
  * This would be misleading if photo is pending

* Add instructions on main menu
  * Ensure tutorial mentions any photo standing for a day is approved
...
* Possible things to use JS for:
  * Refresh boards#show, games#show, and games#index every minute
  * Notifications (on game#show)
  * Adding players to game, on create

* can only create games I'm in?
