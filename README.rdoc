...
* link notifications to a board, instead of a subject AND a game
  * Abandoned, since we want notification to stick around after a board is destroyed (user quits)
...
* Approve any photo standing for a day
...
Possible things to use AJAX for:
  ...
  * Seems pretty unnecessary for everything else
