...
* Approve any photo standing for a day (DJ)
  * Ask Jonathan about why this isn't working
...
* Add tests (RSpec, Capybara)
  * Integration test(s)
  * Unit tests _only_ work with models. Hooray!
  * Use betterspecs.org
...
* Move validations in theme creator into validation
  * Re-factor it when you do this
  * This might be unfeasible, since we can't validate destruction
